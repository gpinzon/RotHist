...
#define NPMODEL 900 /* Number of lines Siess Model files for 1Mo*/
 ...
 */
 ...
 printf(" ## the mass-velocity diagram  ##  \n");
...

{
 ...
 // readm = fopen("k2ov1.csv","r"); /* 209 puntos */
  readmdtres = fopen("m0.13z02.hrd","r"); 
  //ojo:
...

{
 ...
 // readm = fopen("k2ov1.csv","r"); /* 209 puntos */
  readm24 = fopen("m0.13z02.xsurf","r"); 
