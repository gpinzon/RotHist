...
#define NPMODEL 204 /* Number of lines Siess Model files for 1Mo*/
...

{
 ...
 // readm = fopen("k2ov1.csv","r"); /* 209 puntos */
  readmdtres = fopen("m1.1z02.hrd","r"); 
  //ojo:
