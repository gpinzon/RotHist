...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%								       %%
%% Program : history_v15_70Mo.c      				       %%
%% REFUGEE ( Rotational historiEs oF yoUnG stEllar objEcts )           %%
%% -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-..-.-.-..-.-.-..-.-.-.-%%
%% Rotation evolution for a young M*=7.00Mo star                       %%       
%% -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-..-.-.-..-.-.-..-.-.-.-%%
%% APR 2021  						               %%
...
#define NPMODEL 444 /* Number of lines Siess Model files for 1Mo*/
...

{
 ...
 // readm = fopen("k2ov1.csv","r"); /* 209 puntos */
  readmdtres = fopen("m7.0z02.hrd","r"); 
  //ojo:
