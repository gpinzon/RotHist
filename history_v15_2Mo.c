...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%								       %%
%% Program : history_v15_20Mo.c      				       %%
%% REFUGEE ( Rotational historiEs oF yoUnG stEllar objEcts )           %%
%% -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-..-.-.-..-.-.-..-.-.-.-%%
%% Rotation evolution for a young M*=2.00Mo star                       %%       
%% -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-..-.-.-..-.-.-..-.-.-.-%%
%% APR 2021  						               %%
...
#include <ctype.h>
#include <unistd.h>
#define PRECISION 0.000001  /* in Sean's Rt/Rco Solver */
...
"rarstar=%6.3f\t""mui=%6.3f\n""dzdt=%6.4f\t""Rrad(Rsun)=%6.3f\n""step(yr)=%6.3f\t""BCERO=%6.3f\t""tg(Ma)=%6.4f\t""turnover=%6.4f\n""rhk=%6.3f\t""period=%6.3f\n", taoi*(tg/NSMA),alphai,alphaicore,muiprima*NSA/tg,zeti,queca/zeti,rt/zeti,rout/zeti,B,torque,torque_sw,torqueacc_mp,torque_winds,dzdtcore,zero,dip,stepz*(tg/NSA),stepm*(tg/NSA),stepa*(tg/NSA),ef,rarstar,mui,dzdt,radc,step*(tg/NSA),BCERO,tg/NSMA,turnover,rhk,period);
...

{
 ...
 // readm = fopen("k2ov1.csv","r"); /* 209 puntos */
  readmdtres = fopen("m2.0z02.hrd","r"); 
  //ojo:
