...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%								       %%
%% Program : history_v15_10Mo.c      				       %%
%% REFUGEE ( Rotational historiEs oF yoUnG stEllar objEcts )           %%
%% -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-..-.-.-..-.-.-..-.-.-.-%%
%% Rotation evolution for a young M*=1.00Mo star                       %%       
%% -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-..-.-.-..-.-.-..-.-.-.-%%
%% APR 2021  						               %%
...
#define NPMODEL 324 /* Number of lines Siess Model files for 1Mo*/
...
//tg=3.0*G*1.0*1.0*MSUN*MSUN / (28.0*PI*SIGMA*pow(1.715, 3.0)*RSUN*RSUN*RSUN*pow(TEFF,4.0)) ;
...
//tg=NSMA;
 ...
 printf("\n");
 printf("Tiempo(Myr)=%6.4f\n""Velocidad(km/s)=%6.4f\n""Radio(Ro)=%6.4f\n""Masa(Mo)=%6.4f\n""MACC=%6.4f\n",TFINAL,modelspeed,zeti0,mui,MACC);
 printf("\n");
...
double dalpha_dtau(double muiprima, double dzdt, double alphai,double zeti,double mui,double torque,double kdos, double tg, double dinertiacoredt, double inertiaenv)
{
  ...
  //   return  (tg*torque/(kdos*MSUN*pow(RSUN,2.0)*omegasun))*(1.0/(mui*zeti*zeti)) - alphai* (( (muiprima)/mui )+((2.0*dzdt/zeti)))*(tg/NSA);
...

{
 ...
 // readm = fopen("k2ov1.csv","r"); /* 209 puntos */
  readmdtres = fopen("m1.0z02.hrd","r"); 
  //ojo:
