...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%								       %%
%% Program : history_v15_080Mo.c      				       %%
%% REFUGEE ( Rotational historiEs oF yoUnG stEllar objEcts )           %%
%% -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-..-.-.-..-.-.-..-.-.-.-%%
%% Rotation evolution for a young M*=0.80Mo star                       %%       
%% -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-..-.-.-..-.-.-..-.-.-.-%%
%% APR 2021  						               %%
...
#define NPMODEL 384 /* Number of lines Siess Model files for 1Mo*/
...
//tg= (28.0*PI*SIGMA*zeti*zeti*zeti*RSUN*RSUN*RSUN*pow(TEFF,4.0)) / (3.0*G*mui*mui*MSUN*MSUN ) ;
...
double BE(double alphai,double zeti,double BCERO, double turnover)
{
  ...
  //magnetic=BCERO*turnover*(alphai/6.28)/80.0;
 magnetic = BCERO;
...

{
 ...
 // readm = fopen("k2ov1.csv","r"); /* 209 puntos */
  readmdtres = fopen("m0.8z02.hrd","r"); 
  //ojo:
...

{
 ...
 // readm = fopen("k2ov1.csv","r"); /* 209 puntos */
  readm264 = fopen("natalia08.dat","r"); 
